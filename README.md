...
<head>
  ...
  <title>🌻 Sunflower Garden · Motion Art for Manisha</title>
  <!-- Google Fonts: elegant & romantic -->
  <link href="https://fonts.googleapis.com/css2?family=DM+Serif+Display:ital@0;1&family=Quicksand:wght@300;500;700&display=swap" rel="stylesheet">
  <style>
    body {
      margin: 0;
      overflow: hidden;
    ...
    /* motion typography — floating, glowing, handcrafted */
    .valentine-message {
      position: absolute;
      bottom: 12vh;
      left: 0;
      ...
      pointer-events: none;
      text-align: center;
      filter: drop-shadow(0 0 30px rgba(255, 180, 40, 0.6));
      animation: messageAppear 2.2s cubic-bezier(0.12, 0.71, 0.33, 1) forwards;
    }
    .message-card {
      ...
      padding: 28px 48px;
      box-shadow: 0 25px 50px rgba(0,0,0,0.5), 0 0 0 2px rgba(255,220,120,0.2) inset, 0 0 40px #ffbb33;
    ...
    .message-card h1 {
      ...
      line-height: 1.1;
      color: #fff9e6;
      text-shadow: 0 0 15px #ffaa33, 0 0 40px #ff7700, 2px 4px 10px #3a1e00;
      letter-spacing: 2px;
    }
    .message-card p {
      font-size: 1.7rem;
